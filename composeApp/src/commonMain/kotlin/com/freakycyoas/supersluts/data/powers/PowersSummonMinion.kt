...
@Immutable
@Stable
class PowersSummonMinion(selectedLevel: Int? = null): LeveledMainChoice by com.freakycyoas.supersluts.data.DefaultLeveledMainChoice(
    image = Res.drawable.powers_SUMMON_MINION,
    name = "SUMMON MINION",
    levels = listOf(
        com.freakycyoas.supersluts.data.PowerLevel(1, (-8).pp,
