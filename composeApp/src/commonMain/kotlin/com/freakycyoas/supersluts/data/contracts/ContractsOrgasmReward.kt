...
@Immutable
@Stable
object ContractsOrgasmReward: MainChoice by com.freakycyoas.supersluts.data.contracts.ContractChoice(
    ...
    goldPoints = 30.gp,
    incompatibleWith = { listOf(com.freakycyoas.supersluts.data.contracts.ContractsOrgasmPunishment) }
)