...
@Immutable
@Stable
class PowersPowerMode(selectedLevel: Int? = null): LeveledMainChoice by com.freakycyoas.supersluts.data.DefaultLeveledMainChoice(
    image = Res.drawable.powers_POWER_MODE,
    name = "POWER MODE",
    levels = listOf(
        com.freakycyoas.supersluts.data.PowerLevel(1, (-10).pp, buildAnnotatedString {
        ...
        com.freakycyoas.supersluts.data.PowerLevel(2, (-20).pp, buildAnnotatedString {
