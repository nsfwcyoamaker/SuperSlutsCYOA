...
class SimpleDrawbackChoice(
    ...
    @Stable val linkedMainChoice: () -> MainChoice,
): DrawbackChoice,
    PointsBearerItem by DrawbackChoicePointsBearer(givenPowerPoints, { listOf(linkedMainChoice()) }),
    ...
    @Stable override fun getLinkedMainChoices(): List<KClass<out MainChoice>> = listOf(linkedMainChoice()::class)
}